...
void ABaseCharacter::BeginPlay()
{
	...
	SwordCollisionBox->OnComponentBeginOverlap.AddDynamic(this, &ABaseCharacter::SwordBoxBeginOverlap);
	bDead = false;
}
...
float ABaseCharacter::TakeDamage(float DamageAmount, struct FDamageEvent const& DamageEvent, class AController* EventInstigator,
	AActor* DamageCauser)
{
...
void ABaseCharacter::SwordBoxBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp,
