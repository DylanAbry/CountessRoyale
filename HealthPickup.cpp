...
void AHealthPickup::OnOverlapBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp,
	int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	{
		DrawDebugCircle(GetWorld(), GetActorLocation(), 25, 50, FColor::Yellow, false, 5.f, 0, 1.f);
	}
	else
	{
